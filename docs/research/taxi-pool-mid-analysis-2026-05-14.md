...
2026-05-11 から開始した観測ジョブの中間スナップショット (jsonl 846 行、ts 範囲 2026-05-10 13:31:19+09:00 〜 2026-05-15 06:15:23+09:00) を解析した。信頼サブセット 375 行 (schema=3 ∧ luminance>=30 ∧ ts 順序正常 ∧ stalls 非 null) を基準として、5 分刻み出庫量・H6/H8/H9 の暫定傾向、5/31 本分析・ROI v4 設計への提言をまとめる。
...
- 5 分刻み出庫: 信頼サブセット 375 ticks で T1 合計 181 台 / T2 合計 151 台 / 全体 332 台 — 04 時に深夜便ラッシュ (合計 4.36/tick)、8 時に立ち上がり、16 時で急減速
...
|   6.00 |          0.11 |          0.41 |             0.52 |         3.00 |        11.00 |     27.00 |           136.32 |
...
|   6.00 |             3.00 |            11.00 |               14.00 |             140.85 | 27.00 |
...
- occupied_estimate Pearson r = 0.372 (n=375)
- diff_occupied_from_prev Pearson r = 0.412 (n=374)
...
| 指標 | 夜間 | 昼間 |
|---|---|---|
| luminance_std | n=336, mean=18.503, median=23.165, std=10.076 | n=368, mean=42.405, median=44.575, std=9.169 |
| edge_density | n=336, mean=0.073, median=0.084, std=0.060 | n=368, mean=0.253, median=0.287, std=0.095 |
...
**メタ情報**: 分析スクリプト `docs/research/scripts/phase-a-mid-analysis.py` を実行 (2026-05-15 06:15:23+09:00 時点の jsonl)。再現性のため commit 済み。venv は `~/.venvs/taxi-ic-phase-a/`。
