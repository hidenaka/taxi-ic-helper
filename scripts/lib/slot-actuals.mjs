 ...
 * (現行 forecast と同挙動)。mode 切替 tick の diff は 0 (擬似出庫防止)。
 *
 * 注意: fill 履歴が浅い間 (開始 2026-05-20) は patternMatch/baseline の候補日が不足する。
 * fill 履歴が十分貯まってから observe-taxi-pool の forecast 入力をこれに切替える想定。
 *
